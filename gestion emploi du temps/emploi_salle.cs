...
namespace gestion_emploi_du_temps
{
    public partial class emploi_salle : Form
    {
        ...
        private void seance(string jour, string heuredebut, string heurefin, Label label1, Label label2, Label label3)
        {
            String cmd = "select * from Seance S ,Element M,module MO,semestre Se,Filiere F , Salle SA,Groupe G ,Enseignant E where E.id_enseignant=S.id_enseignant and G.id_groupe=S.id_groupe and SA.id_salle=S.id_salle and  S.id_element=M.id_element and MO.id_semestre=SE.id_semestre and MO.id_module=S.id_module and S.heure_debut='" + heuredebut + "' and S.heure_fin='" + heurefin + "' and MO.id_Filiere=F.id_filiere and jour='" + jour + "'and nom_semestre='" + semestrebox.Text + "'and SA.nom_salle='" + sallebox.Text + "'";
