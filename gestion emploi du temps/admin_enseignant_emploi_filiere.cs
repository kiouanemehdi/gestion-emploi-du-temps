...
namespace gestion_emploi_du_temps
{
    public partial class admin_enseignant_emploi_filiere : Form
    {
        ...
        {
            String query = "select * from seance S ,matiere M,module MO,semestre Se,Filiere F , Salle SA,Groupe G ,Enseignant E where E.id_enseignant=S.Id_enseignant and G.id_groupe=S.id_groupe and SA.id_salle=S.id_salle and  S.id_element=M.id_element and MO.id_semestre=SE.id_semestre and MO.id_module=S.id_module and S.heure_debut='" + hdebut + "' and S.heure_fin='" + hfin + "' and MO.id_Filiere=F.id_filiere and jour='" + jour + "' and nom_semestre='" + semestrebox.Text + "'and F.nom_filiere='" + filierebox.Text + "' and G.nom_groupe = '" + groupebox.Text + "'";
