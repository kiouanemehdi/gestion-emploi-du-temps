...
namespace gestion_emploi_du_temps
{
    public partial class chef_gestion_ens : UserControl
    {
        ...
        private void refresh()
        {
            ...
            {
                sqlAdapter = new SqlDataAdapter("SELECT id_enseignant as Id,nom_enseignant as [Nom],Prenom_enseignant as Prénom,ens_username as [Nom d'utilisateur],ens_password as [Mot de passe] FROM Enseignant ", cn.conn);
