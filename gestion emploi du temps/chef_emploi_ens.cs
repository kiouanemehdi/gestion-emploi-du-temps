...
{
    public partial class chef_emploi_ens : Form
    {
        SqlConnection cn;
        ...
        private void chef_emploi_ens_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand sc = new SqlCommand("select * from Enseignant", cn);
        ...
        private void ensbox_SelectedIndexChanged(object sender, EventArgs e)
        {
            refresh();
        }
